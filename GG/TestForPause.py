...
class MainWindow(QWidget):
    ...
    def run_facial_recognition(self):
        ...
        QTimer.singleShot(100, self.process_facial_recognition)
    ...
    def run_nfc_recognition(self):
        self.display_processing_message()
        QTimer.singleShot(100, self.process_nfc_recognition)

    def process_nfc_recognition(self):
        def on_connect(tag):
    ...
    def display_processing_message(self):
        ...
        self.processing_label = QLabel("Processing, please wait...", self)
        self.processing_label.setStyleSheet("font-size: 18px; color: white;")
